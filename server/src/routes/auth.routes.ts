...
router.post("/signup", authRateLimiter, validateBody(signupCustomerSchema), authController.signupCustomer);
router.post("/employee-signup", authRateLimiter, validateBody(employeeBootstrapSchema), authController.employeeSetup);
